...
import { CheckAnswerRepositoryTypeorm } from "./adapter/output/typeorm/check-answer-repository.typeorm";
import { CreateQuizRepositoryTypeormAdapter } from "./adapter/output/typeorm/create-quiz-repository.typeorm.adapter";
import { DeleteQuizRepositoryTypeormAdapter } from "./adapter/output/typeorm/delete-quiz-repository.typeorm.adapter";
...
import { FindQuizByIdRepositoryTypeormAdapter } from "./adapter/output/typeorm/find-quiz-by-id-repository.typeorm.adapter";
import { FindQuizByUrlRepositoryTypeormAdapter } from "./adapter/output/typeorm/find-quiz-by-url-repository.typeorm.adapter";
import { GetQuizUrlsRepositoryAdapter } from "./adapter/output/typeorm/get-quiz-urls-repository.adapter";
